package org.example.lagomdevopsexample.api
...
object LagomDevopsExampleService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The lagom-devops-example service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LagomdevopsexampleService.
  */
trait LagomDevopsExampleService extends Service {
  ...
  override final def descriptor: Descriptor = {
    import Service._
    // @formatter:off
    named("lagom-devops-example")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(LagomDevopsExampleService.TOPIC_NAME, greetingsTopic _)
